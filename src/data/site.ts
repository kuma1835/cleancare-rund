...
export const site = {
  ...
  gruendung: 2009,
  /** Einzelne Person — für Signaturen unter persönlichen Aussagen. */
  geschaeftsfuehrung: 'Aylin Özcakir',
  /** Vollständige Vertretung — für Impressum und Datenblätter. Beide Namen sind Pflicht. */
  vertretung: 'Aylin Özcakir, Levent Özcakir',
